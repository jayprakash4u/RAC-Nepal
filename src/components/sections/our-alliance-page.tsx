...
export function OurAllianceWhatIs() {
  const { whatIs } = ourAlliancePage;
...
export function OurAlliancePartners() {
  const { partners } = ourAlliancePage;
...
export function OurAllianceComparison() {
  const { comparison } = ourAlliancePage;
    ...
    <Section background="default" spacing="default">
      <Container size="wide">
        ...
        <div className="section-content grid gap-lg lg:grid-cols-2 lg:gap-xl">
          <ComparisonCard
            title={comparison.forPatients.title}
            items={comparison.forPatients.items}
            variant="primary"
          />
          <ComparisonCard
            title={comparison.forPartners.title}
            items={comparison.forPartners.items}
            variant="secondary"
          />
        </div>
      </Container>
...
export function OurAllianceHowItWorks() {
  const { howItWorks } = ourAlliancePage;
    ...
    >
      ...
      >
        <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
          <path
            d="M7 10h10M7 14h6M6 4h8l4 4v12H6V4z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
...
export function OurAllianceBenefits() {
  const { benefits } = ourAlliancePage;
...
export function OurAlliancePartnership() {
  const { partnership } = ourAlliancePage;
      ...
      <Container size="wide">
        ...
        <div className="section-content mx-auto max-w-[40rem] rounded-2xl border border-white/70 bg-white/90 p-lg shadow-sm backdrop-blur-sm sm:p-xl">
          ...
          <div className="mt-xl flex justify-center">
            <Button href={partnership.cta.href} size="lg">
